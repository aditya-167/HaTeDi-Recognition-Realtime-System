...
#define AI_NETWORK_MODEL_SIGNATURE     "85ae819c94236ab700a16bdc6b21176c"
...
#define AI_TOOLS_DATE_TIME   "Tue Feb  4 23:40:19 2020"
...
AI_STATIC ai_array conv2d_2_bias_array;   /* Array #5 */
AI_STATIC ai_array conv2d_2_weights_array;   /* Array #6 */
...
AI_STATIC ai_array conv2d_2_output_array;   /* Array #11 */
AI_STATIC ai_array dense_1_output_array;   /* Array #12 */
AI_STATIC ai_array dense_1_nl_output_array;   /* Array #13 */
AI_STATIC ai_array dense_2_output_array;   /* Array #14 */
AI_STATIC ai_array dense_2_nl_output_array;   /* Array #15 */
...
AI_STATIC ai_tensor conv2d_2_bias;   /* Tensor #5 */
AI_STATIC ai_tensor conv2d_2_weights;   /* Tensor #6 */
...
AI_STATIC ai_tensor conv2d_2_output;   /* Tensor #11 */
AI_STATIC ai_tensor conv2d_2_output0;   /* Tensor #12 */
...
AI_STATIC ai_tensor dense_2_nl_output;   /* Tensor #16 */
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 64, 24, 2), AI_STRIDE_INIT(4, 4, 4, 256, 6144),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 9216, 128, 1, 1), AI_STRIDE_INIT(4, 1, 9216, 1179648, 1179648),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 32, 26, 26), AI_STRIDE_INIT(4, 4, 4, 128, 3328),
  1, &conv2d_1_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  conv2d_2_output, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 64, 12, 12), AI_STRIDE_INIT(4, 4, 4, 256, 3072),
  1, &conv2d_2_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
  conv2d_2_output0, AI_STATIC,
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 9216, 1, 1), AI_STRIDE_INIT(4, 4, 4, 36864, 36864),
  1, &conv2d_2_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
